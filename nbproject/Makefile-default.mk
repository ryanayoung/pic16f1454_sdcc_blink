...
${OBJECTDIR}/main.o: main.c  nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} "${OBJECTDIR}" 
	${RM} ${OBJECTDIR}/main.o 
	${MP_CC} --use-non-free --debug -c -mpic14 -p16f1454 main.c  -o${OBJECTDIR}/main.o
	
else
${OBJECTDIR}/main.o: main.c  nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} "${OBJECTDIR}" 
	${RM} ${OBJECTDIR}/main.o 
	${MP_CC} --use-non-free -c -mpic14 -p16f1454 main.c  -o${OBJECTDIR}/main.o
...
dist/${CND_CONF}/${IMAGE_TYPE}/first_project.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} -Wl-c -Wl-m --use-non-free -mpic14 -p16f1454 ${OBJECTFILES_QUOTED_IF_SPACED} -odist/${CND_CONF}/${IMAGE_TYPE}/first_project.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} 
else
dist/${CND_CONF}/${IMAGE_TYPE}/first_project.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} -Wl-c -Wl-m --use-non-free -mpic14 -p16f1454 ${OBJECTFILES_QUOTED_IF_SPACED} -odist/${CND_CONF}/${IMAGE_TYPE}/first_project.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} 
